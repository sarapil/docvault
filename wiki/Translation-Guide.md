...
```bash
bench --site dev.localhost get-untranslated ar --app docvault
```

### 2. Translation file format — تنسيق ملف الترجمة

File: `docvault/translations/ar.csv`
...
bench --site dev.localhost get-untranslated ar --app docvault | wc -l
```
...
2. Edit/create the CSV file in `docvault/translations/`
