...
# Includes in <head>
app_include_css = [
    "/assets/docvault/css/docvault-theme.css",
    "/assets/docvault/css/docvault-variables.css",
]
app_include_js = [
    "/assets/docvault/js/docvault_boot.js",
    "/assets/docvault/js/fv_integration.js",
]
